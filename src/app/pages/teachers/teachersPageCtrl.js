...
(function () {
    ...
    /** @ngInject */
    function TeachersPageCtrl($scope,$state, $http,$location,$filter, editableOptions, editableThemes) {
      // 取当前管理员信息
      ...
      $scope.teacherCreate = function(){
        $state.go('teachers.teacherEdit',{teacher_type:1});
      };
      
  // 跳到老师详情页面，需要带id
      $scope.teacherEdit = function(){
        $state.go('teachers.teacherEdit',{teacher_id:'',teacher_type:2});
      }  
      ...
      $scope.initPage = function(){
        ...
        .success(function(data){
          ...
          $scope.teachers = data.body.page.list; 
        })
        .error(function(data){
          alert(data.msg);
        })
